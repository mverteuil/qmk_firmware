...
#    define LAYER_NUMBERS_SONG SONG(COLEMAK_SOUND)
#    define LAYER_NUMPAD_SONG SONG(NUMPAD_SOUND)
#    define LAYER_LOWER_SONG SONG(LOWER_SOUND)
#    define LAYER_RAISE_SONG SONG(RAISE_SOUND)
#else
//   No-op version of PLAY_SONG instead of many checks for AUDIO_ENABLE
#    ifndef PLAY_SONG
